...
import com.example.firebasetestapp.Activity.In_Thread_Activity
...
//    }
    ...
    class MainThreadItemViewHolder(view: ViewGroup) : RecyclerView.ViewHolder(view) {
        ...
        val createdAtThread : TextView? = view.findViewById(R.id.one_result_createdAtThread_mainThread)
